...
\title[Restrictive rules]{Restrictive rules in the Chilean Cámara}
...
\institute[ITAM-UC-UI]{\inst{1} ITAM, Mexico \and 
                       \inst{2} Univ.~Católica, Chile \and
                       \inst{3} U.\ of Illinois, Urbana-Champaign}
\date[1sep17]{\small{APSA, San Francisco} \\ Sept.\ $1^{st}$, 2017}
...
Howell\&Moe (2016) argue for constitutional reform to grant U.S.\ presidents \textbf{universal fast track authority}
