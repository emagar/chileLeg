...
\title[Restrictive rules]{Restrictive rules in Chile's Congress}
...
\date[16may15]{\small{Taller La Ciencia Pol\'itica desde M\'exico} \\ May 26th, 2017}
...
\bi
\item Speed of consideration (Siavelis): \begin{tabular}{ll}
    urgent & 29.0 weeks \\
    rest   & 29.7 weeks \\
  \end{tabular}
...
\item Urgency is a signalling device (Alemán\&Navia) 
  
\item We explore a different rationale: \\ urgency $\neq$ accelerator \\ urgency = \textbf{restrictive rule}
\ei
...
\bi
\item Urgency $\rightarrow$ closed rule
\item Unlike Rules Committee, Chilean prez controls this 
\item Test?
  \be
  \item Study amendments, admitted v.\ not
  \item Corr(amendments, urgency)<0?  
  \item Role of shorter deadlines $\rightarrow$ abort amendment threats?
  \ee
