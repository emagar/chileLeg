...
\title[Espátula]{Un método para obtener texto del internet y analizarlo}
\subtitle{\emph{Selenium} y las páginas ricas en \emph{javascript}}
\author[Magar]{Eric Magar}
\institute[ITAM]{ITAM}
\date[9nov17]{\small{1er Simposio TLH en las ciencias sociales} \\ 9/11/2017}
...
\frame {                      % SLIDE
    ...
    Obtener/sistematizar historia legislativa de iniciativas en Chile
...
\frame {                      % SLIDE
    ...
    Página web de la Cámara de Diputados de Chile \url{http://camara.cl}
    ...
    javascript: información ausente del código, se ``contruye'' a través de solicitudes
...
\frame {                      % SLIDE
    ...
    \alert{Selenium}
        ...
        Módulo de Python que permite abrir un navegador, hacer login, emular el mouse y sus clics, etc.

        \bigskip

Solución no es eficiente, pero es eficaz
