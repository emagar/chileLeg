...
\emm{La ventaja de 47 es que enfatiza la separación de poderes. La ventaja de 70 es que subraya la aceleración del proceso, que es lo que la literatura (y el término urgencia) han considerado. Quizás econtremos una intersección de ambas ideas...}
...
\ges{Soto dice que Ecuador, Paraguay y Dominicana tienen poderes de urgencia tambien, y ita Base de Datos Politicos de las Americas (2008) de Georgetown University.}
...
\emm{It does, but only id amendments were in fact introduced. Model totally ignores this. Simplistic? Justifiable? May need some elaboration.}
